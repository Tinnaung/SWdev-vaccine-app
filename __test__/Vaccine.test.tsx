  ...
  data: [
    {
      ...
      __v: 0,
      id: "652017541a371f96336fdb2f",
    },
    {
      _id: "652017ca1a371f96336fdb32",
      ...
      __v: 0,
      id: "652017ca1a371f96336fdb32",
    },
    {
      _id: "652018161a371f96336fdb35",
  ...
  it("should have correct number of hospital images", async () => {
    ...
    await waitFor(
        () => {
            ...
            expect(hosImages.length).toBe(3);
        }
    );
  });
});
